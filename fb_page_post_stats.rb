...
fbaccesstoken = YAML::load(File.open('config/api_tokens.yml'))['api_tokens']['fbaccesstoken']
...
output['data'].nil? ? log_time("Error \n#{output['error'].inspect}") : fbcounts = output['data'] 
